...
def load_model(num_classes, pretrained=True):
    logging.info(f"Cargando modelo SlowFast_R50 (pretrained={pretrained}) para {num_classes} clases.")
    try:
        ...
        model.blocks[6].proj = nn.Linear(original_head_in_features, num_classes)
